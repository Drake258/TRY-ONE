...
export default async function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <nav className="bg-gray-900/80 backdrop-blur-md border-b border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/login" className="bg-violet-600 hover:bg-violet-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition">
              Staff Login
            </Link>
          </div>
        </div>
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-gray-900 to-violet-950/30 border-b border-gray-800 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-white mb-2">Our Products</h1>
          <p className="text-gray-400">Browse our complete catalog — <span className="text-violet-400 italic">&ldquo;We give you options.&rdquo;</span></p>
        </div>
      </div>
              ...
              <div key={product.id} className="bg-gray-800/50 border border-gray-700 rounded-2xl overflow-hidden hover:border-violet-500/50 hover:shadow-lg hover:shadow-violet-500/5 transition group">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xl font-bold text-violet-400">₵{product.price.toFixed(2)}</span>
